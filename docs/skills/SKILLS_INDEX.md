...
| preflight-export | `C:\Users\carucci_r\.claude\skills\preflight-export\SKILL.md` | [how_to/preflight-export.md](how_to/preflight-export.md) | [global_skills.md](global_skills.md) | Validate raw CAD/RMS/arrest/summons drops before ETL (size/open/header/delimiter/gotcha drift checks; stdout Markdown only) |
...
| inventory-wave | `C:\Users\carucci_r\.claude\skills\inventory-wave\SKILL.md` | [how_to/inventory-wave.md](how_to/inventory-wave.md) | [global_skills.md](global_skills.md) | Workbook_Redesign Phase 1: last-6-month + `_mom` + aux inventory to `Docs/wave_<letter>_inventory.md` (macros, validation gaps, flat-schema map) |
| clean-cad-export | `C:\Users\carucci_r\.claude\skills\clean-cad-export\SKILL.md` | [how_to/clean-cad-export.md](how_to/clean-cad-export.md) | [global_skills.md](global_skills.md) | Workbook_Redesign CAD cleanup: coerce case-number dtype, normalize `How Reported`, strip whitespace/newlines, and emit cleaned workbook plus diff report |
| clean-summons-export | `C:\Users\carucci_r\.claude\skills\clean-summons-export\SKILL.md` | [how_to/clean-summons-export.md](how_to/clean-summons-export.md) | [global_skills.md](global_skills.md) | Workbook_Redesign summons ETL cleanup to produce `Data_Load/summons_slim_for_powerbi.csv` (semicolon parse, whitespace trim, date normalization, slash-column split) |
| clean-arrest-export | `C:\Users\carucci_r\.claude\skills\clean-arrest-export\SKILL.md` | [how_to/clean-arrest-export.md](how_to/clean-arrest-export.md) | [global_skills.md](global_skills.md) | Workbook_Redesign arrest cleanup for LawSoft/ATS exports (S2 totals drop, whitespace trims, reviewed normalization, Race/UCR split, artifact column removal) |
| standardize-compstat-wb | `C:\Users\carucci_r\.claude\skills\standardize-compstat-wb\SKILL.md` | [how_to/standardize-compstat-wb.md](how_to/standardize-compstat-wb.md) | [global_skills.md](global_skills.md) | Workbook_Redesign Phase 3: per-workbook Compstat redesign (`Docs/redesign_<unit>.md`, `pReportMonth` M code, macro-free flat schema; optional XML surgery opt-in) |
| session-handoff | `C:\Users\carucci_r\.claude\skills\session-handoff\SKILL.md` | [how_to/session-handoff.md](how_to/session-handoff.md) | [global_skills.md](global_skills.md) | Generate a structured session handoff (OPENING PROMPT + HANDOFF BODY) and archive it to `00_dev/handoffs/<date>_<topic>_handoff_v<N>.md` for chained continuity across chat sessions |
