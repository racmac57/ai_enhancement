...
| session-handoff | `C:\Users\carucci_r\.claude\skills\session-handoff\SKILL.md` | [how_to/session-handoff.md](how_to/session-handoff.md) | [global_skills.md](global_skills.md) | Emit a two-part **SESSION HANDOFF DOCUMENT** (OPENING PROMPT + HANDOFF BODY) for the next chat — strict nil-states, PII guardrails, word ceiling, one-item NEXT BEST ACTION |
