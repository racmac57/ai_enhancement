...
| arcgis-pro | `C:\Users\carucci_r\.claude\skills\arcgis-pro\SKILL.md` | _pending (Phase 7)_ | [global_skills.md](global_skills.md) | Guide arcpy scripts for ArcGIS Pro's bundled Python (no pip, scratchGDB, exec-compatible) |
| data-validation | `C:\Users\carucci_r\.claude\skills\data-validation\SKILL.md` | _pending (Phase 7)_ | [global_skills.md](global_skills.md) | Run standard data quality checks on Excel or CSV datasets before deployment |
...
| etl-pipeline | `C:\Users\carucci_r\.claude\skills\etl-pipeline\SKILL.md` | _pending (Phase 7)_ | [global_skills.md](global_skills.md) | Standard ETL workflow for CAD/RMS/Arrests/Summons pipelines under 02_ETL_Scripts |
